...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonGetSuggestion.setOnClickListener {
            ...
            if (suggestion.isNotEmpty()) {
                ...
                Toast.makeText(this, "Please enter a valid time of day (Morning, Afternoon," +
                        " etc.)", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    // Function to provide a suggestion based on the input time of dayarih97HHH*mC
